...
if ff['freq_opt'] == 'central':
    ...
    ff['fmin']             = 0.4 # freq min ...
    ff['fmax']             = 1.8 # freq max ...
...
for index_day in tt['day']: # LOOP OVER DAYS
    ...
    in_['full_data_dir']       = in_['data_dir']  + "/data_%d.0"%ff['fs'] + "hz_cooked/daily/" + in_['tag'] + "/%04d"%tt['year'] + "/"
    ...
    if bb['stack_daily']:
        ...
        beam_file = in_['beam_dir'] + '/beam_' +  bb['compo'] + '_' + f"{tt['year']}_" +  in_['name_h5']
        io_beam.write_h5(beam_file, save_dic)
