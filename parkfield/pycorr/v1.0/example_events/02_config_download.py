...
in_['ch']             = ['LH','BH'] # ['ch1','ch2',...] It will try in this order. Better to start from the lower sampling rate ['LH','BH','HH'...]
in_['cmp']            = ['Z'] # ['cmp1','cmp2',...]
...
in_['ev']['time_after']    = 0 # [s] from source time, if 0, autoscale from magnitude (empirical): exp(mag**3/450)-1 days
